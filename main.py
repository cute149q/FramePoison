...
def main():
    ...
    args.eval_dataset = "nfcorpus" #"trec-covid"  # For debugging, set to a specific dataset
    args.model_name = "llama38b"
    args.name = "llama38b_nfcorpus_k5_dev"
    args.split = "dev"  # Set to dev for debugging
    args.top_k= 5
    ...
    incorrect_answers = load_json(f"results/adv_targeted_results/{args.eval_dataset}_llama38b_dev.json")
    ...
    if args.orig_beir_results is None:
        ...
        if args.split == "test":
            args.orig_beir_results = f"results/beir_results/{args.eval_dataset}-{args.eval_model_code}-nonempty.json"
        elif args.split == "dev":
